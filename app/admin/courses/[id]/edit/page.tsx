...
export default function EditCoursePage({
    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({
          ...
          module_ids: data.course.module_ids || [],
        });
      } else {
  ...
  function removeModule(moduleId: string) {
    setFormData({
      ...formData,
      module_ids: formData.module_ids.filter((mid) => mid !== moduleId),
    });
  }
  ...
  const selectedModules = formData.module_ids
    .map((mid) => availableModules.find((m) => m.id === mid))
    ...
    <div>
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-gray-600">Update course details and modules</p>
        </div>
      </div>
