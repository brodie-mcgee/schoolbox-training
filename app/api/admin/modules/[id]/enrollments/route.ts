...
// GET - List all enrollments for a specific module
export async function GET(
  ...
  try {
    ...
    // Get all enrollments for this module with user details
    ...
    if (enrollmentError) {
      console.error("[/api/admin/modules/[id]/enrollments] Error:", enrollmentError);
    ...
    console.error("[/api/admin/modules/[id]/enrollments] Error:", error);
    return NextResponse.json(
...
export async function DELETE(
  ...
  try {
    ...
    if (error) {
      console.error("[/api/admin/modules/[id]/enrollments] Delete error:", error);
...
export async function PATCH(
  ...
  try {
    ...
    if (error) {
      console.error("[/api/admin/modules/[id]/enrollments] Update error:", error);
